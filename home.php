...
<section class="about" id="about">
    ...
    <div class="content">
        ...
        <p>A gym is a club, building, or large room, usually containing special equipment, where people go to do physical exercise and get fit.</p>
        <div class="box-container">
            <div class="box">
                <h3><i class="fas fa-check"></i>body and mind</h3>
                <p>Two sides of the same coin, our mind and body are interconnected. What affects one affects the other. What we eat and how much we move go beyond causing physical changes, they affect our mind. S</p>
            </div>
            <div class="box">
                <h3><i class="fas fa-check"></i>healthy life</h3>
                <p>A healthy lifestyle includes regular exercise, a healthy diet, taking good care of self, healthy sleep habits, and having a physically active daily routine. Lifestyle is the most prevailing factor that affects one's fitness level.</p>
            </div>
            <div class="box">
                <h3><i class="fas fa-check"></i>strategies</h3>
                <p> strategy is a general plan or set of plans intended to achieve something, especially over a long period. The group hope to agree a strategy for policing the area..</p>
            </div>
            <div class="box">
                <h3><i class="fas fa-check"></i>workout</h3>
                <p>Research has shown that it's important to get all four types of exercise: endurance, strength, balance, and flexibility. Each one has different benefits</p>
            </div>
        </div>
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <div class="content">
                ...
                <h3>gym for women</h3>
                <p> “It is easy to find strong women. They are the ones who are seen in the gym!”</p>
                <!-- <a href="#" class="btn">read more</a> -->
            </div>
        </div>
...
<section class="pricing" id="pricing">
    ...
    <div class="information">
        ...
        <p>Before diving into your gym project plan, take some time to clearly define your fitness objectives. Are you looking to build muscle, lose weight, increase endurance, or improve overall fitness? By identifying your goals, you can tailor your gym project plan to meet your specific needs.
</p>
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <div class="content">
                ...
                <div class="share">
                    ...
                    <a href="https://www.instagram.com/shreyygupta/" class="fab fa-instagram"></a>
        ...
        <div class="box">
            ...
            <div class="content">
                ...
                <div class="share">
                    <a href="#" class="fab fa-facebook-f"></a>
                    <a href="https://www.instagram.com/indian_gym_girls/" class="fab fa-instagram"></a>
                    <a href="#" class="fab fa-pinterest"></a>
                    <a href="#" class="fab fa-linkedin"></a>
                </div>
            </div>
        ...
        <div class="box">
            ...
            <div class="content">
                <span>Weight Lifting trainer</span>
                <h3>ishaanthakurr</h3>
                <div class="share">
                    <a href="#" class="fab fa-facebook-f"></a>
                    <a href="https://www.instagram.com/ishaanthakurr/" class="fab fa-instagram"></a>
                    <a href="#" class="fab fa-pinterest"></a>
                    <a href="#" class="fab fa-linkedin"></a>
                </div>
            </div>
        ...
        <div class="box">
            ...
            <div class="content">
                ...
                <div class="share">
                    <a href="#" class="fab fa-facebook-f"></a>
                    <a href="https://www.instagram.com/theindianyogagirl/" class="fab fa-instagram"></a>
                    <a href="#" class="fab fa-pinterest"></a>
                    <a href="#" class="fab fa-linkedin"></a>
                </div>
            </div>
...
<section class="banner">
    ...
    <p>Shape your future, join our gym today,
With discounts soaring, there's no delay.
Strength, health, and savings, hand in hand,
Unlock your potential, join our fitness band</p>
...
<section class="footer">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <p> <i class="fas fa-phone"></i> 7030596559 </p>
            <p> <i class="fas fa-envelope"></i> befit007@gmail.com </p>
            <p> <i class="fas fa-map"></i> pune, india - 560035 </p>
            <div class="share">
                <a href="#" class="fab fa-facebook-f"></a>
...
<div class="credit"> created by <span>SURAJ.A.PATIL</span> | all rights reserved! </div>
